...
void AdvanceLightingScene::CreateObjects()
{
	...
	ShaderFilePath shader_file_path
	{
		...
		"Assets/Shaders/Learning/AdvanceLighting/ModelFrag.glsl", //fragment shader
	};
	...
	{
		"Assets/Shaders/Learning/AdvanceLighting/InstancingVertex.glsl", //vertex shader
		"Assets/Shaders/Learning/AdvanceLighting/ModelFrag.glsl", //fragment shader
	};
	...
	{
		"Assets/Shaders/Learning/ScreenFrameVertex.glsl", //vertex shader
		"Assets/Shaders/Learning/ScreenFrameFrag.glsl", //vertex shader
	};
	screenShader.Create("shadow_depth", screen_shader_file_path);

	ShaderFilePath point_light_debuging_file
	{
		"Assets/Shaders/Learning/Debugger/DebugCubeMapDepthVertex.glsl", //vertex shader
		"Assets/Shaders/Learning/Debugger/DebugCubeMapDepthFrag.glsl", //fragment shader
	};
